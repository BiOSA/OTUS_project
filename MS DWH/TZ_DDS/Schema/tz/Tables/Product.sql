...
GO
CREATE NONCLUSTERED INDEX IX_tz_Product_BatchId ON tz.[Product](BatchId, ProductId) INCLUDE (EffectiveDateTill);
GO
CREATE NONCLUSTERED INDEX IX_tz_Product_EffectiveDateTill ON tz.Product (EffectiveDateTill, Product_RK) INCLUDE (RatePerDay);
GO
GRANT DELETE, INSERT, UPDATE ON tz.Product TO tz_report;