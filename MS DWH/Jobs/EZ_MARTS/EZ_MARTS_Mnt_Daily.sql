...
/****** Object:  Job [EZ_MARTS_Mnt_Daily]    Script Date: 28.11.2023 12:01:06 ******/
BEGIN TRANSACTION
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'EZ_MARTS_Mnt_Daily', 
		@enabled=1, 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'Джоб со служебными процедурами для EZ_MARTS', 
