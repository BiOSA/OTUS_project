schema = [
    ...
    {"name": "PrincipalDebt", "type": "NUMERIC"},
    {"name": "InterestDebt", "type": "NUMERIC"},
    {"name": "PenaltyDebt", "type": "NUMERIC"},
    {"name": "FineDebt", "type": "NUMERIC"},
    {"name": "AmountAccrued", "type": "NUMERIC"},
    {"name": "TypeId", "type": "UUID"},
    {"name": "StatusId", "type": "UUID"},
    {"name": "NoPay", "type": "BOOLEAN"},
    {"name": "PaymentScheduleId", "type": "UUID"},
    {"name": "CancelDate", "type": "TIMESTAMP"},
    {"name": "StateDutyDebt", "type": "NUMERIC"},
