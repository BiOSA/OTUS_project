schema = [
    ...
    {"name": "is_for_cashless_settlement", "type": "BOOLEAN"},
    {"name": "knowledge_base_id", "type": "UUID"},
    {"name": "prolongation_offer_id", "type": "UUID"},
    {"name": "prolongation_offer_old_id", "type": "UUID"},
